  ...
  return (
    <Layout>
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Genos:wght@600&family=Playfair+Display&family=Roboto+Condensed&display=swap"
          rel="stylesheet"
        ></link>
      </Head>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8">
            ...
            >
              ...
              <div className="font-fancy text-lg">
                ...
                temporada. Equipada con una computadora de alto rendimiento,
                todo lo que necesitas para tu trabajo está al alcance de tu
                mano. Nuestra ubicación privilegiada te brinda acceso a una
                cafetería cercana, donde puedes disfrutar de bebidas y alimentos
                deliciosos en tus momentos de descanso.
              </div>
            </Link>
          </div>
